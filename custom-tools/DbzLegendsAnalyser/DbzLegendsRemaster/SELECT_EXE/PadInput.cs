...
//   * FUN_800261a4 installs them: InitPAD(&DAT_80055d6c, 0x22, &DAT_80055d8e, 0x22). The two
//     addresses are 0x22 apart, so the pair is one contiguous 68-byte region at 0x80055D6C.
//   * FUN_800261e4 indexes STRAIGHT ACROSS BOTH as one region: `(&DAT_80055d6c)[param_1 * 0x22]`,
//     which only type-checks if they are adjacent. It returns byte +0 of the selected buffer, and
//     both consumers read 0 as "pad present" (FUN_80030ef8 line 10; FUN_800315c0 lines 96/121).
...
{
    // GHIDRA: DAT_80055d6c @ 0x80055D6C
    // The FIRST status buffer, 0x22 bytes, and — because FUN_800261e4 walks across the boundary —
    ...
    internal static readonly byte[] DAT_80055d6c = new byte[0x44];

    // GHIDRA: DAT_80055af0 @ 0x80055AF0
    // .sbss, undefined1 (Ghidra types all four of these as single bytes and they sit one byte
    // apart). PAD 1's CIRCLE hold counter.
    private static byte DAT_80055af0;

    // GHIDRA: DAT_80055af1 @ 0x80055AF1
    // .sbss, undefined1. PAD 2's CIRCLE hold counter.
    private static byte DAT_80055af1;

    // GHIDRA: DAT_80055af4 @ 0x80055AF4
    // .sbss, undefined1. PAD 1's CROSS hold counter.
    private static byte DAT_80055af4;

    // GHIDRA: DAT_80055af5 @ 0x80055AF5
    // .sbss, undefined1. PAD 2's CROSS hold counter.
    private static byte DAT_80055af5;
    ...
    internal static void FUN_800261a4()
    {
        InitPAD(DAT_80055d6c, 0, 0x22, 0x22, 0x22);
        StartPAD();
        ChangeClearPAD(0);
    }

    // GHIDRA: FUN_800261e4 @ 0x800261E4
    // Thirty-six bytes, no callees. `return (&DAT_80055d6c)[param_1 * 0x22];` — byte +0 of buffer
    ...
    // raw; FUN_80033d34 @ 0x80033D34 and FUN_800283a0 @ 0x800283A0 run their own cadence on them.
    //
    ...
    internal static ushort FUN_80026208(int param_1)
    {
        ...
        uVar1 = (ushort)~(ushort)((DAT_80055d6c[0x02] << 8) | DAT_80055d6c[0x03]);
        if ((uVar1 & 0x20) == 0)
        {
            DAT_80055af0 = 0;
        }
        ...
        if (param_1 == 4)
        {
            ...
            bMask = 1 < DAT_80055af0;
        }
        else
        {
            uVar2 = (ushort)(uVar1 & 0x20);
            bMask = DAT_80055af0 != 0;
        }
        ...
        if (uVar2 != 0)
        {
            DAT_80055af0 = (byte)(DAT_80055af0 + 1);
        }
        ...
        if (param_1 == 4)
        {
            ...
            bMask = 1 < DAT_80055af4;
        }
        else
        {
            uVar2 = (ushort)(uVar1 & 0x40);
            bMask = DAT_80055af4 != 0;
        }
        ...
        if (param_1 == 4)
        {
            ...
            bMask = 1 < DAT_80055af1;
        }
        else
        {
            uVar3 = (ushort)(uVar2 & 0x20);
            bMask = DAT_80055af1 != 0;
        }
        ...
        if (uVar3 != 0)
        {
            DAT_80055af1 = (byte)(DAT_80055af1 + 1);
        }
    ...
    LAB_80026388:
        if (uVar3 != 0)
        {
            DAT_80055af5 = (byte)(DAT_80055af5 + 1);
        }
