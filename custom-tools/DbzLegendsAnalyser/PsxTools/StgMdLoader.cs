...
// ─────────────────────────────────────────────────────────────────────────────
//  STGxMD.B loader — MonoGame version.
//  Pure data model using Microsoft.Xna.Framework.Color instead of System.Drawing.Color.
...
public static class StgMdLoader
{
    ...
    public static StgModelFile Load(byte[] data)
    {
        ...
        uint meshTableOffset    = LE32(data, 0);
    ...
    private static (Color c0, Color c1, Color c2, Color c3) ReadColors(byte[] data, int off, int primType)
    {
        switch (primType)
        {
            case 4: { var c = Clr(data, off + 32); return (c, c, c, c); }
            case 5: { var c = Clr(data, off + 40); return (c, c, c, c); }
            case 6: return (Clr(data, off + 48), Clr(data, off + 52),
                            Clr(data, off + 56), Color.White);
            case 7: return (Clr(data, off + 64), Clr(data, off + 68),
...
// ─────────────────────────────────────────────────────────────────────────────
//  Data model (uses Microsoft.Xna.Framework.Color)
// ─────────────────────────────────────────────────────────────────────────────
...
{
    POLY_FT3 = 0, POLY_FT4 = 1, POLY_GT3 = 2, POLY_GT4 = 3,
    POLY_F3  = 4, POLY_F4  = 5, POLY_G3  = 6, POLY_G4  = 7,
}
